...
const index = (props: Props) => {
  ...
  const { data, error, isLoading } = useSWR(
    [`https://onlineedu.pythonanywhere.com/api/course/course/${courseSlug}/`],
          ...
          <Grid.Col md={6}>
             <Paper p="sm">
               ...
               <Text size="sm" mt="md" color="dimmed">
                 From Bulbapedia: Bulbasaur is a small, quadrupedal Pokémon that has blue-green skin with darker patches. It has red eyes with white pupils, pointed, ear-like structures on top of its head, and a short, blunt snout
               </Text>
               <Box sx={{display: 'flex', alignItems: 'center'}} mt="xl">
                  <Text size="sm"  color="dimmed">
                    {"O'qtuvchi:"}
                  </Text>
                  <Text size="sm" c="blue.3" ml="sm">{data.teacher_name}</Text>
               </Box>
